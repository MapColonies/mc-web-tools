...
class Config {
  ...
  public apps = APPS || '{"nominatim":{"category":"Vector","name":"Nominatim","icon":"/assets/img/globe.gif","url":"https://nominatim.openstreetmap.org/ui/search.html","width":132},"sandcastle":{"category":"Cesium","name":"Sandcastle","icon":"/assets/img/cesium-sandcastle.png","url":"https://sandcastle.cesium.com","width":200}}';
}
