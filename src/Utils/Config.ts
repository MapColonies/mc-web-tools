...
class Config {
  ...
  public apps = APPS || '{"nominatim":{"category":"Vector","name":"Nominatim","icon":"/assets/img/nominatim.svg","url":"https://nominatim.openstreetmap.org/ui/search.html","width":200,"tooltip":"Nominatim is a search engine for OpenStreetMap data. You may search for a name or address (forward search) or look up data by its geographic coordinate (reverse search)"},"sandcastle":{"category":"Cesium","name":"Sandcastle","icon":"/assets/img/cesium.webp","url":"https://sandcastle.cesium.com","width":200,"tooltip":"Sandcastle is a live-coding app for viewing CesiumJS examples. Contextual CesiumJS help for quickly sharing and testing code"}}';
}
